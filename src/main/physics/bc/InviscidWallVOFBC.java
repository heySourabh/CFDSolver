...
public class InviscidWallVOFBC implements BoundaryCondition {
    private final ArtificialCompressibilityVOFEquations govEqn;

    public InviscidWallVOFBC(ArtificialCompressibilityVOFEquations govEqn) {
        this.govEqn = govEqn;
    }

    @Override
    public void setGhostCellValues(Face face) {
        // extrapolate pressure and C
        ...
        double[] ghostCellPrimVars = new double[]{
                p, mirroredVelocity.x, mirroredVelocity.y, mirroredVelocity.z, C
        };
