...
public class SolverSloshing2DHLLCStructuredTest {
    ...
    public static void main(String[] args) throws IOException {
        new SolverSloshing2DHLLCStructuredTest().solver();
    }
    ...
    public void solver() throws IOException {
        ...
        int[] expectedPseudoIterations = {
                362, 261, 150, 176, 178, 175, 161, 150, 125, 133, 139, 124, 149, 156, 160, 160, 151, 153, 164,
                217, 182, 187, 183, 178, 171, 164, 162, 159, 160, 145, 132, 148, 159, 165, 163, 158, 143, 163,
                196, 165, 183, 179, 174, 169, 163, 154, 134, 131, 135, 137
        };

        int[] actualPseudoIterations = new int[numRealIter];

        File outputFolder = new File("test/test_data/sloshing_hllc_structured/");
