...
public class SolverLidDrivenCavityHLL2DTest {
    ...
    public void solver() {
        ...
        new VTKWriter(new File("test/test_data/lid_driven_cavityHLL2d.vtu"), mesh, problem.govEqn()).write();
        Assert.assertEquals(3034, iter);
    }
}